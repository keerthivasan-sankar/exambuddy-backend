...
// Message Schema - UPDATED with all fields
...
// GET Messages - Supports global, group, and private
...
// POST Message - Supports global, group, and private
...
app.post('/api/chats/private/:otherUserId', authMiddleware, async (req, res) => {
    try {
        ...
        await newMessage.save();
        await newMessage.populate('userId', 'name avatar');
        console.log(`🔒 Private message saved to: ${otherUserId}`);
        res.status(201).json(newMessage);
    } catch (error) {
